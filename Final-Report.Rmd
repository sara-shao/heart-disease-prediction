...
### SVM:
Compared to the logistic regression model, the SVM performs better for prediction (13.7% misclassification rate), as we expected. However, this model does not tell us much about what factors are or aren't important in predicting heart disease, and it cannot tell us actually likelihoods of having heart disease or not. 
