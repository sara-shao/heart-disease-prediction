...
```
UPDATE THIS WITH 5 FOLD CV RESULT Our final SVM model uses a linear kernel with a cost of 5.623. The error rate for this model is 12.05%. We will compare the error rate of this model with the error rate of our other two models to decide if this is the model we will end up using for predicting heart disease.


###CROSS VALIDATION
ADD COMMENTARY HERE ON HOW WE PICKED BEST MODEL
